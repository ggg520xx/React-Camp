...
import { DivCoverStyled } from './MemberBasicStyle'
                        ...
                        <div className='row '>
                            ...
                            <div className="col-5">
                                ...
                                <div className="row">
                                    ...
                                    <div className='col-7 text-left'>
                                        <strong className='block mb-2'><button onClick={handleVisible}>操作-三元判斷顯示以留言並patch 後disable按鈕 未留言就可以點開</button></strong>
                                    </div>
                                </div>
