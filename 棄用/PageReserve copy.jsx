...
import { ga1, ga2, pic404 } from '../src/images/page/PageMange';


import MyDatePicker from '../src/components/page/item/func/ReactDateRange';
                                ...
                                <div className="col-4  pl-0  relative ">
                                    ...
                                    <div className="flex flex-col justify-around items-center h-full py-3">
                                        ...
                                        <div className="w-full">
                                            ...
                                            <select id={`quantity-${index}`} value={quantity[index]} onChange={(e) => handleQuantityChange(index, e.target.value)} className="w-full px-5 border border-psub_color ">
