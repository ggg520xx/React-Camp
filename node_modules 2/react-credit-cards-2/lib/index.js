...
var ReactCreditCards = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ReactCreditCards, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (prevProps.number !== number) {
        ...
        if (typeof callback === 'function') {
          callback(this.options, (0, _cardHelpers.validateLuhn)(number));
        }
      }
    ...
    get: function get() {
      ...
      if (_cardHelpers.cardTypesMap.amex.indexOf(this.issuer) !== -1 || _cardHelpers.cardTypesMap.dinersclub.indexOf(this.issuer) !== -1) {
        var format = [0, 4, 10];
        var limit = [4, 6, 5];
    ...
    get: function get() {
      ...
      if (number) {
        ...
        if (this.validCardTypes.indexOf(validatedIssuer) !== -1) {
    ...
    get: function get() {
      ...
      if (acceptedCards.length) {
        return initialValidCardTypes.filter(function (card) {
    ...
    key: "updateValidCardTypes",
    value: function updateValidCardTypes(acceptedCards) {
      if (acceptedCards.length) {
        return this.validCardTypes.filter(function (card) {
          return acceptedCards.indexOf(card) !== -1;
        });
      }
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        className: ['rccs__card', "rccs__card--".concat(this.issuer), focused === 'cvc' && this.issuer !== 'american-express' ? 'rccs__card--flipped' : ''].join(' ').trim()
      }, /*#__PURE__*/_react.default.createElement("div", {
